...
SUPABASE_URL: str = os.environ.get("SUPABASE_URL", "https://ansiaiuaygcfztabtknl.supabase.co")
...
def main() -> None:
    ...
    app = Application.builder().token(TELEGRAM_BOT_TOKEN).post_shutdown(_shutdown_cleanup).build()
